      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6 sm:space-y-8 relative z-10">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 pt-4 sm:pt-6 px-4">
          <button
            ...
            className="w-full sm:w-auto px-8 sm:px-10 py-3.5 sm:py-4 rounded-xl bg-[#ddb049] hover:bg-[#c99a3a] text-[#0a0704] text-base sm:text-lg font-black shadow-[0_10px_30px_rgba(221,176,73,0.3)] border-b-[5px] border-[#b8862f] hover:border-b-[2px] hover:translate-y-[3px] transition-all cursor-pointer"
          >
            Start Learning
          </button>
          <button
            onClick={openConsultation}
            className="w-full sm:w-auto px-8 sm:px-10 py-3.5 sm:py-4 rounded-xl bg-white hover:bg-[#fbfaf7] text-slate-800 border border-[#e8e0d2] text-base sm:text-lg font-bold shadow-sm transition-all cursor-pointer"
          >
            Book a Consultation
          </button>
        </div>
