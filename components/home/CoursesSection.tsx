        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          {courses.map((course) => (
            <Link
              ...
              className="group bg-white rounded-2xl border border-slate-200 shadow-sm hover:shadow-xl overflow-hidden transition-all cursor-pointer flex flex-col"
            >
              {/* Thumbnail */}
              ...
              <div className="p-5 flex-1 flex flex-col">
                {/* Category */}
                <div className="mb-2">
                  <span className="text-[10px] uppercase font-black tracking-widest px-2.5 py-1 rounded-full bg-cyan-50 text-[#07CCFD] border border-cyan-100">
                ...
                <div className="flex items-start justify-between gap-2 mb-2">
                  <h3 className="text-lg font-black text-slate-900 leading-tight line-clamp-2 group-hover:text-[#07CCFD] transition-colors">
                    {course.title}
                  </h3>
                  <ArrowUpRight className="w-4 h-4 text-slate-400 group-hover:text-[#07CCFD] shrink-0 mt-1 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-all" />
                </div>
                ...
                <div className="mt-auto pt-4 border-t border-slate-100 flex items-center justify-between">
                  ...
                  <span className="text-xs font-bold text-slate-500 group-hover:text-[#07CCFD]">
                    View Course →
                  </span>
                </div>
              </div>
